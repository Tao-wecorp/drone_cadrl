...
class DroneEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        """
        Initializes a new DroneEnv environment.
        ...
        * /drone/land: Publish to make Drone Land
        
        Args:
        """
        rospy.logdebug("Start DroneEnv INIT...")
        ...
        super(DroneEnv, self).__init__(controllers_list=self.controllers_list,
        ...
        rospy.logdebug("Finished DroneEnv INIT...")
